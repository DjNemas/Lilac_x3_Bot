...
//{
//    public class CommandsMods : CommandsHeaderChat
//    {
//        [Command("edituser")]
//        public async Task ModulsAsync(SocketGuildUser user)
//        {
//            string args = user.Id.ToString();
...
//        public async Task ShowUserTodayAsync(SocketGuildUser user)
//        {
//            await ShowUser(user.Id.ToString(), ShowUserEnum.Today);
//        }

//        [Command("showuseryesterday")]
//        public async Task ShowUserYesterdayAsync(SocketGuildUser user)
//        {
//            await ShowUser(user.Id.ToString(), ShowUserEnum.Yesterday);
//        }
